...
var annotations = [
	...
	},
	{
		...
		"page": "Step 5",
	 	"comment": "The options in this dropdown/select menu will be different based on the product select on Step 1 (e.g., if it's a mortgage complaint, 'additional card holder' shouldn't be an option. The case statements for these options are listed on line 1310 of your-information.html, and in <a href=\"https://GHE/consumer-response/021-consolidated-form/issues/80\">GitHub issue #80</a> This allows the bureau and the companies receiving the complaint to understand the additional complainant's role in the transaction."
	},
	{
